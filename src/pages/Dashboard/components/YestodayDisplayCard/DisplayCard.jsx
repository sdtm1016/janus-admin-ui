        ...
        <Row wrap>
          <Col xxs="24" s="12" l="6" style={styles.item}>
            ...
            <div style={styles.desc} className="desc">
              <span>较前日 {down} -59481</span>
              <span style={{ marginLeft: 5 }}>近7天 {up} +604371</span>
            </div>
          </Col>
          <Col xxs="24" s="12" l="6" style={styles.item}>
            <div style={styles.title} className="title">
            ...
            <div style={styles.desc} className="desc">
              <span>较前日 {down} -136</span>
              <span style={{ marginLeft: 5 }}>近7天 {up} +1390</span>
            </div>
          </Col>
          <Col xxs="24" s="12" l="6" style={styles.item}>
            <div style={styles.title} className="title">
          ...
          <Col xxs="24" s="12" l="6" style={styles.item}>
            ...
            <div style={styles.desc} className="desc">
              <span>较前日 {up} +70432</span>
              <span style={{ marginLeft: 5 }}>近7天 {up} +89623</span>
            </div>
          </Col>
        </Row>
      </IceContainer>
