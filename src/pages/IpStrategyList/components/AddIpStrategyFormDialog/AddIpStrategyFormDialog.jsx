...
export default class AddIpStrategyFormDialog extends Component {

  static displayName = 'AddIpStrategyFormDialog';
            ...
            <div style={styles.dialogContent}>
              ...
              <Row style={styles.formRow}>
                <Col span={`${isMobile ? '6' : '3'}`}>
                  <label style={styles.formLabel}>策略名称</label>
                </Col>
                <Col span={`${isMobile ? '18' : '16'}`}>
                  <IceFormBinder
                    ...
                    min={5}
                    max={50}
                    message="IP控制策略名称非法,名称必须唯一，支持汉字、英文字母、数字、英文格式的下划线，必须以英文字母或汉字开头，4~50个字符"
                  >
                    <Input
                      name="name"
                      style={styles.input}
                      placeholder="请输入IP控制策略名称"
                    />
                  </IceFormBinder>
              ...
              <Row style={styles.formRow}>
                <Col span={`${isMobile ? '6' : '3'}`}>
                  <label style={styles.formLabel}>控制类型</label>
                </Col>
                <Col>
                  <IceFormBinder>
                    <RadioGroup
              ...
              <Row style={styles.formRow}>
                <Col>
                  <IceFormBinder
                    ...
                    min={1}
                    max={180}
                    message="IP控制策略描述长度不符合要求,请控制在0-180个字符"
                  >
                    <Input
                      name="description"
                      style={styles.input}
                      multiple
                      placeholder="请输入IP控制策略描述"
                      rows={4}
                    />
                  </IceFormBinder>
